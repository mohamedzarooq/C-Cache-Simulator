# C-Cache-Simulator
A basic L1 cache simulator that I created in C that simulates how hits and misses and loading data from different hierarchies or main memory works in modern cpu's. L3 simply means level 3, which is the highest level in a cache hierarchy in most modern cpu's (L1, L2, L3). 
